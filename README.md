...
| [`tools/`](tools/) | empty, deliberately. Read its README before adding anything. |
...
- **The CI workflow files are scaffolds.** They pin actions to tags rather than
  commits, because a commit hash cannot be written honestly without resolving
  it. The file says how to resolve it and why you should.
