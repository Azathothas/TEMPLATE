...
# is a SELECTION made at adoption, and it is cheaper than any removal.
#
...
# docs/methodology/ are engineering rather than agent instruction.
# lean-adoption.md names all four. Read them, write them into the project's own
# contributing guide, THEN run this.
#
# Usage:
...
if (-not $Apply) {
    ...
    Write-Output ''
    Write-Output '⛔ Read docs/methodology/lean-adoption.md before removing any of this.'
    Write-Output 'Four practices in docs/methodology/ are engineering rather than agent'
    Write-Output "instruction. Lift them into the project's own contributing guide first."
    Write-Output ''
...
Write-Output ("removed {0} agent-facing file(s)." -f $hits.Count)
Write-Output ''
